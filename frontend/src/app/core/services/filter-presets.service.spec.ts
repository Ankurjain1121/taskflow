...
describe('FilterPresetsService', () => {
  ...
  describe('list()', () => {
    it('sends GET /api/projects/{boardId}/filter-presets', () => {
  ...
  describe('create()', () => {
    it('sends POST /api/projects/{boardId}/filter-presets with the request body', () => {
  ...
  describe('update()', () => {
    it('sends PUT /api/projects/{boardId}/filter-presets/{presetId} with the request body', () => {
  ...
  describe('delete()', () => {
    it('sends DELETE /api/projects/{boardId}/filter-presets/{presetId}', () => {
