...
describe('BulkOperationsService', () => {
  ...
  describe('previewOperation()', () => {
    it('should POST to /api/projects/:projectId/bulk-operations/preview', () => {
  ...
  describe('executeOperation()', () => {
    it('should POST to /api/projects/:projectId/bulk-operations/execute', () => {
      service
  ...
  describe('listOperations()', () => {
    it('should GET /api/projects/:projectId/bulk-operations', () => {
