...
describe('TaskService', () => {
  ...
  describe('createTask()', () => {
    it('should POST to /api/projects/:projectId/tasks with body', () => {
  ...
  describe('listByBoard()', () => {
    it('should GET /api/projects/:projectId/tasks and extract tasks map', () => {
  ...
  describe('listFlat()', () => {
    it('should GET /api/projects/:projectId/tasks/list', () => {
  ...
  describe('listCalendarTasks()', () => {
    it('should GET /api/projects/:projectId/tasks/calendar with start and end params', () => {
  ...
  describe('listGanttTasks()', () => {
    it('should GET /api/projects/:projectId/tasks/gantt', () => {
  ...
  describe('bulkUpdate()', () => {
    it('should POST /api/projects/:projectId/tasks/bulk-update', () => {
  ...
  describe('bulkDelete()', () => {
    it('should POST /api/projects/:projectId/tasks/bulk-delete', () => {
