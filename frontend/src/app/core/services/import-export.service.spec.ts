...
describe('ImportExportService', () => {
  ...
  describe('exportCsv()', () => {
    it('should GET /api/projects/:projectId/export with format=csv and blob responseType', () => {
  ...
  describe('exportJson()', () => {
    it('should GET /api/projects/:projectId/export with format=json', () => {
  ...
  describe('importJson()', () => {
    it('should POST /api/projects/:projectId/import with tasks array', () => {
  ...
  describe('importCsv()', () => {
    it('should POST /api/projects/:projectId/import/csv with csv_text', () => {
  ...
  describe('importTrello()', () => {
    it('should POST /api/projects/:projectId/import/trello with trello data', () => {
