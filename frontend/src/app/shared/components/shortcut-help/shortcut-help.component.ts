      ...
      >
        ...
        >
          ...
          <div class="px-6 py-4 space-y-6">
                ...
                <div class="space-y-1">
                  @for (s of cat.shortcuts; track s.key) {
                    <div class="flex items-center justify-between py-1.5">
                      ...
                      <kbd class="px-2 py-0.5 text-xs font-mono bg-gray-100 border border-gray-300 rounded text-gray-600">
                        {{ formatShortcut(s) }}
                      </kbd>
                    </div>
                  }
            ...
            <div>
              <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Help</h3>
              <div class="flex items-center justify-between py-1.5">
                <span class="text-sm text-gray-700">Show this help</span>
                <kbd class="px-2 py-0.5 text-xs font-mono bg-gray-100 border border-gray-300 rounded text-gray-600">?</kbd>
              </div>
            </div>
          </div>
        </div>
