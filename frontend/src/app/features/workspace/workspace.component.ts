        ...
        @if (loading()) {
          ...
          @if (boards().length === 0) {
            ...
            >
              ...
              <h3 class="text-lg font-medium text-gray-700 mb-2">No boards yet</h3>
              <p class="text-gray-500 mb-6 max-w-md mx-auto">
                Boards help you organize work into visual workflows. Create your first
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              @for (board of boards(); track board.id) {
                <a
                  ...
                  class="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-md hover:border-blue-300 transition-all duration-200 cursor-pointer group block"
                >
