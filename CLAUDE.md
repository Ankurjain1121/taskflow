...
- **Default theme:** "Warm Earth" — fired-terracotta primary (`#A0663E` light / `#996535` dark), with Kiln Copper (`#BF7B54`) as the sidebar/accent color and warm parchment neutrals (`#E8E4DB` light bg / `#1C1A17` dark bg). Card surfaces are `#EDE9DD` light / `#262320` dark. Red reserved for errors/destructive actions only.
