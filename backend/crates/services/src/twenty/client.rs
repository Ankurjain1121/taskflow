//! Version-tolerant Twenty CRM HTTP client
...
impl VersionTolerantClient {
    ...
    pub async fn detect_version(&self) -> Result<String, TwentyError> {
    ...
    pub async fn call<T: de::DeserializeOwned>(
        ...
        if !response.status().is_success() {
            ...
            return Err(TwentyError::Api { status, message });
        }
        ...
        match serde_json::from_str::<T>(&body) {
            ...
            Err(e) => {
                ...
                Err(TwentyError::Serialization(e))
            }
        }
    }
