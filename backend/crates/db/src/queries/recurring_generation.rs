...
/// 2. INSERT a new task with same title (append " (recurring)"), description, priority, column_id, project_id, tenant_id, created_by_id
...
pub async fn create_recurring_instance(
    ...
    let source_task = sqlx::query_as::<_, SourceTask>(
        r#"
        SELECT id, title, description, priority, column_id, project_id,
    ...
    sqlx::query(
        ...
        INSERT INTO tasks (
            ...
            column_id, project_id, position, tenant_id, created_by_id,
