...
async fn list_workspaces(
    ...
    let project_map: std::collections::HashMap<Uuid, i64> = project_counts.into_iter().collect();
    let member_map: std::collections::HashMap<Uuid, i64> = member_counts.into_iter().collect();
