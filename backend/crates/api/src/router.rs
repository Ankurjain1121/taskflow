...
use crate::routes::{
    ...
    shared_project_public_router, subtask_router, task_crm_links_router, task_group_routes,
    task_issue_link_router, task_labels_router, task_router, task_snooze_router,
